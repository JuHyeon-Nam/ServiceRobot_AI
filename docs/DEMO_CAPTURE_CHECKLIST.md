...
| 1:45-2:05 | `/api/work-orders` and `/api/dispatch-plan` | AI output becomes maintenance priority and SLA |
...
- PHM/RUL is currently a transparent heuristic and is marked as replaceable by a calibrated model.
